...
|
*/
$config['base_url'] = getenv('APP_BASE_URL') ? rtrim(getenv('APP_BASE_URL'), '/').'/' : ((isset($_SERVER['HTTP_HOST']) ? ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http').'://'.$_SERVER['HTTP_HOST'].rtrim(dirname($_SERVER['SCRIPT_NAME']), '/\\').'/' : 'http://localhost/'));
...
|
*/
$config['encryption_key'] = getenv('APP_KEY') ? getenv('APP_KEY') : 'absen-rs-ci3-php74-mobile-key-2026';
